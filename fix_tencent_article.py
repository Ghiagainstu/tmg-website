...
def fix_article(slug, lang):
    ...
    obsidian_path = OBSIDIAN / 'Tencent' / 'Tencent Ads Home & Furnishing Influencer Marketing A Complete Playbook for 2026' / f'{lang.upper()}.md'
...
# Fix the article
slug = 'tencent-ads-home-furnishing-ja'
lang = 'ja'
